...
2.  **Ручная геопривязка:** Пользователю необходимо открыть полученные снимки в программе QGIS, назначить им координаты и сохранить полученные изображения в формате .tif в папку `data/photos_geotiff`.
...
4.  **Удаление суши:** Необходимо запустить модуль `coords_without_earth.py`, который удаляет из полученного изображения части, относящиеся к суше.
