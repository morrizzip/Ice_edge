...
2.  **Ручная геопривязка:** Пользователю необходимо открыть полученные снимки в программе QGIS, назначить им координаты и сохранить полученные изображения в формате .tiff в папку `data/photos_geotiff`, расположенную в одной директории со всеми программными модулями проекта.
