import adding_ice_data_api as api
...
file_poly = '.txt' #координаты для полигонов
file_line = '.txt' #координаты для линий
...
# k = api.split_coordinates_file(file_poly)
#
# for i in range(k):
...
# k = api.split_coordinates_file(file_line)
#
# for i in range(k):
...
#
#     result_coords = api.convert_coordinates(file_path_line)
#     print(result_coords)
#
#     response = api.addMLinesToVectorLayer(res_url, mlID, result_coords)
